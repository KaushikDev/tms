...
const Button = ({
  ...
  const getButtonStyle = () => {
    ...
    if (btnSecondary)
      return "text-gray-600 border border-gray-400 bg-gray-100 hover:border-gray-900 hover:text-gray-900";
    if (btnSpecial)
      return "text-gray-900 border border-gray-900 bg-gray-100 hover:text-gray-100 hover:bg-gray-900";
    if (btnDanger)
      return "text-gray-900 border border-gray-900 bg-gray-100 hover:text-gray-100 hover:bg-red-900";
